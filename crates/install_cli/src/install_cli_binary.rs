...
actions!(
    cli,
    [
        /// Installs the Rally IDE CLI tool to the system PATH.
        InstallCliBinary,
    ]
);
...
pub fn install_cli_binary(window: &mut Window, cx: &mut Context<Workspace>) {
    const LINUX_PROMPT_DETAIL: &str = "If you installed Rally IDE from our official release add ~/.local/bin to your PATH.\n\nIf you installed Rally IDE from a different source like your package manager, then you may need to create an alias/symlink manually.\n\nDepending on your package manager, the CLI might be named zeditor, zedit, zed-editor or something else.";
                    ...
                    workspace.show_notification(
                        ...
                        |cx| {
                            cx.new(|cx| {
                                ...
                                .with_title("Couldn't install the Rally IDE CLI")
    ...
    .detach_and_prompt_err("Cannot install the Rally IDE CLI", window, cx, |_, _, _| None);
}
