    ...
    fn general_settings_section(_cx: &App) -> Vec<SettingsPageItem> {
        vec![
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Optimize Rally IDE's interface for assistive technology such as screen readers. When enabled, otherwise-collapsed controls stay expanded and keyboard-reachable.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn security_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "When opening Rally IDE, avoid Restricted Mode by auto-trusting all projects, enabling use of all features without having to give permission to each new project.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn workspace_restoration_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "What to restore from the previous session when opening Rally IDE.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn scoped_settings_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Which settings should be activated only in Preview build of Rally IDE.",
                field: Box::new(
                    SettingField {
                        organization_override: None,
    ...
    fn privacy_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data like what languages you're using Rally IDE with.",
                field: Box::new(SettingField {
                    organization_override: None,
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    files: USER,
                    title: "Icon Theme",
                    description: "The custom set of icons Rally IDE will associate with files and directories.",
                    field: Box::new(SettingField {
                        organization_override: None,
    ...
    fn file_scan_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be excluded by Rally IDE entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                field: Box::new(
                    SettingField {
                        organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be included by Rally IDE, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down Rally IDE's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                field: Box::new(
                    SettingField {
                        organization_override: None,
    ...
    fn window_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "(Linux only) whether Rally IDE or your compositor should draw window decorations.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether breakpoints should be reused across Rally IDE sessions.",
                field: Box::new(SettingField {
                    organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to log messages between active debug adapters and Rally IDE.",
                field: Box::new(SettingField {
                    organization_override: None,
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    description: "Disable all Git integration features in Rally IDE.",
                    field: Box::new(SettingField::<bool> {
                        organization_override: None,
...
fn ai_page(cx: &App) -> SettingsPage {
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Disable AI",
                description: "Whether to disable all AI features in Rally IDE.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn agent_configuration_section(_cx: &App) -> Box<[SettingsPageItem]> {
        ...
        items.extend([
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Command to automatically run when Rally IDE creates a Terminal Thread shell in the agent panel. Runs in your configured shell.",
                field: Box::new(SettingField {
                    organization_override: None,
...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn autoclose_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Use Autoclose",
                description: "Whether to automatically type closing characters for you. For example, when you type '(', Rally IDE will automatically add a closing ')' at the correct position.",
                field: Box::new(SettingField {
                    organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', Rally IDE will automatically surround text with ().",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn tasks_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Prefer LSP",
                description: "Use LSP tasks over Rally IDE language extension tasks.",
                field: Box::new(SettingField {
                    organization_override: None,
...
fn edit_prediction_language_settings_section() -> [SettingsPageItem; 5] {
    [
        ...
        SettingsPageItem::SubPageLink(SubPageLink {
            ...
            description: Some("Set up different edit prediction providers in complement to Rally IDE's built-in Zeta model.".into()),
            search_aliases: &[],
            in_json: false,
            files: USER,
        ...
        SettingsPageItem::SettingItem(SettingItem {
            ...
            description: "Controls whether Rally IDE may collect training data when using Rally IDE's Edit Predictions. Data is only collected for files in projects detected as open source. The default value uses the preference previously set via the status-bar toggle, or false if no preference has been stored.",
            field: Box::new(SettingField {
